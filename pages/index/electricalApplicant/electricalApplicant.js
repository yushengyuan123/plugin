// pages/index/electricalApplicant/electricalApplicant.js
...
Page({
    ...
    toPortOption() {
        ...
        wx.navigateTo({
            url: './setParam/setParam?index=' + this.data.currentPort + '&name=' + this.data.currentName
                + '&isAdd=false',
        })
    },
    /**
